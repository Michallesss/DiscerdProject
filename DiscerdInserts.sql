...
INSERT INTO `account` (`accountID`, `login`, `password`, `phone`, `email`, `nickname`, `aboutme`, `status`, `activity`, `pfp`, `banner`)
VALUES (NULL, 'maciekcieslak', 'maciuskox', '519643782', 'promaciek@wp.pl', 'dzikimacius69', 'rozkład? jazdy jazda z kurwami', 'hej bejb', NULL, NULL, NULL);
...
INSERT INTO `friendship` (`friendshipID`, `accountID1`, `accountID2`, `status`)
VALUES (NULL, '1', '2', '1');
INSERT INTO `friendship` (`friendshipID`, `accountID1`, `accountID2`, `status`)
VALUES (NULL, '3', '1', '0');
...
INSERT INTO `channel` (`ID_channel`, `categoryID`, `name`, `weight`, `type`)
...
VALUES (NULL, 'pieck', null, '1', '1');
INSERT INTO `emoji_sticker` (`emoji_stickerID`, `name`, `picture`, `type`, `serverID`)
VALUES (NULL, 'piec', null, '2', '1');

INSERT INTO `message` (`ID_message`, `ID_sender`, `ID_recipient`, `groupID`, `ID_channel`, `messagedate`, `content`)
...
INSERT INTO `permission` (`ID_permission`,`permission_name`,`permission_value`,`permission_desc`)
VALUES
