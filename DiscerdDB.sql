...
(
    ...
    `accountID1` INT(11), FOREIGN KEY (`accountID1`) REFERENCES `account`(`accountID`),                             /*who invited*/
    `accountID2` INT(11), FOREIGN KEY (`accountID2`) REFERENCES `account`(`accountID`),                             /*who's invited*/
